...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="https://vora.dexignlab.com/xhtml/images/favicon.png">
            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-6">
                    <div class="form-input-content text-center error-page">
						...
						<div>
                            <a class="btn btn-primary" href="https://vora.dexignlab.com/xhtml/index.html">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
